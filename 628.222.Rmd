...
####
ggplot(users, aes(x =factor(1), fill = factor(occupation)))+geom_bar(width = 1)+ coord_polar(theta = "y")+scale_fill_discrete(guide=guide_legend(title = "Occupation"))+ggtitle("The proportion of Occupation")+xlab("")
####
